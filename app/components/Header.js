    ...
    return (
        <div style={{ height: "66px", display: "flex", alignItems: "center", width: "100%", justifyContent: "space-around" }}>
            ...
            <div style={{ display: "flex", gap: "50px" }}>
                <Typography.Text style={{ fontFamily: "Avenir LT Std", fontStyle: "normal", fontWeight: "400", fontSize: "16px", lineHeight: "25px", color: pageSel == "Main" || pageSel == "projects" ? "#302E2E" : "#AFAFAF", cursor: "pointer" }}>Projects</Typography.Text>
