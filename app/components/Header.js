...
const Header = ({ pageSel }) => {
    return (
        <div style={{ height: "66px", display: "flex", alignItems: "center", width: "100%", justifyContent: "space-around" }}>
            <Typography.Link href="/" onClick={()=>{message.info("version 1.2.1")}} style={{ fontFamily: "Avenir LT Std", fontStyle: "normal", fontWeight: "400", fontSize: "16px", lineHeight: "19px", color: "#AFAFAF" }}>Vinod Raichur</Typography.Link>
